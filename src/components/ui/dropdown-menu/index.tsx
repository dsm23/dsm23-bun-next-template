...
const DropdownMenu: FunctionComponent<MenuPrimitive.Root.Props> = ({
  ...props
}) => <MenuPrimitive.Root data-slot="dropdown-menu" {...props} />;

const DropdownMenuPortal: FunctionComponent<MenuPrimitive.Portal.Props> = ({
  ...props
}) => <MenuPrimitive.Portal data-slot="dropdown-menu-portal" {...props} />;

const DropdownMenuTrigger: FunctionComponent<MenuPrimitive.Trigger.Props> = ({
  ...props
...
const DropdownMenuGroup: FunctionComponent<MenuPrimitive.Group.Props> = ({
  ...props
...
const DropdownMenuSub: FunctionComponent<MenuPrimitive.SubmenuRoot.Props> = ({
  ...props
...
> = ({ className, children, inset, closeOnClick = true, ...props }) => (
